...
class SkinDetector:
    """Face detection and skin region extraction using MediaPipe"""
    ...
    def __init__(self):
        ...
        self.logger.info("🎯 SkinDetector initialized with MediaPipe")
    ...
    def get_average_skin_color(self, image: np.ndarray, skin_mask: np.ndarray) -> Dict:
        """
        Calculate average skin color from masked region
        ...
        Returns:
            Dictionary with average skin color information
        """
        try:
